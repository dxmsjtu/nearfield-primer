...
Ndim = 10;  %default value is 100, for speedy simulations, 10;
...
distance_B = (2*D_antenna*Ndim)/(fraunhoferDistanceAntenna); %(18) of [1]
...
%Determine the normalized antenna array gains that is achieved at different distances
...
set(gca,'XScale','log');xticks([10 100 1000 10000 100000])
